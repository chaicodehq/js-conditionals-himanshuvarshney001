...
export function getSeasonActivity(month, temp) {
  ...
  if (month === 12 || month === 1 || month === 2) {
    if (temp < 0) return { season: "Winter", activity: "skiing" };
    else return { season: "Winter", activity: "ice skating" };
  }
  else if (month === 3 || month === 4 || month === 5)
  {
    if (temp > 20) return { season: "Spring", activity: "hiking" };
    else return { season: "Spring", activity: "museum visit" };
  }
  else if (month === 6 || month === 7 || month === 8)
  {
    if (temp > 35) return { season: "Summer", activity: "swimming" };
    else return { season: "Summer", activity: "cycling" };
  }
  else if (month === 9 || month === 10 || month === 11)
  {
    if (temp > 15) return { season: "Autumn", activity: "nature walk" };
